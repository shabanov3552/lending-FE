(() => {
    ...
    function initSliders() {
        if (document.querySelector(".packs__slider")) {
            document.querySelector(".packs__card_main");
            new swiper_core_Swiper(".packs__slider", {
                observer: true,
                observeParents: true,
                speed: 800,
                breakpoints: {
        ...
        if (document.querySelector(".rewiews__slider")) new swiper_core_Swiper(".rewiews__slider", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
